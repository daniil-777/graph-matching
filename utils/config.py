...
# CUB Dataset
__C.CUB = edict()
__C.CUB.KPT_ANNO_DIR = 'data/CUB/annotations/'  # keypoint annotation
__C.CUB.ROOT_DIR = 'data/CUB/'  # original VOC2011 dataset
__C.CUB.SET_SPLIT = 'data/CUB/voc_cub_pairs.npz'  # set split path
__C.CUB.CLASSES = ['Flycatcher', 'Gull', 'Sparrow', 'Tern', 'Vireo', 'Warbler', 'Woodpecker', 'Wren']
